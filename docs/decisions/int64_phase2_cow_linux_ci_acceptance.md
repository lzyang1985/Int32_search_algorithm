...
| 字段 | 值 |
|------|-----|
| 原始路径 | `docs/tasks/task_006_int64_phase2_cow/ACCEPTANCE_V1_V2_V3_linux_ci.md` |
| 归档日期 | 2026-06-08 |
| 归档类型 | decisions/acceptance |
| 原始 status | Frozen |
| task_id | task_006_int64_phase2_cow |
| parent_task | task_005_int64_extension |
| 验证平台 | Linux GCC 11.4.0 + TSan (103.236.63.60) |

*本文档由文档管理 Agent 在 2026-06-08 自动归档。原始任务文档不变，本归档副本为 Frozen 快照。*
